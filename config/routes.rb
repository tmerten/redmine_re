RedmineApp::Application.routes.draw do
  ...
  match 'projects/:project_id/requirements/treestate/:mode' => 'requirements#treestate'
  match 'projects/:project_id/requirements/treestate/:mode/:id' => 'requirements#treestate'
