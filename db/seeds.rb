...
Role.create("assignable"=>true, "builtin"=>1, "issues_visibility"=>"default", "name"=>"Non member", "permissions"=>[], "position"=>1)
Role.create("assignable"=>true, "builtin"=>2, "issues_visibility"=>"default", "name"=>"Anonymous", "permissions"=>[], "position"=>2)
...
ReArtifactRelationship.create("position"=>2, "relation_type"=>"parentchild", "sink_id"=>5, "source_id"=>2)
ReArtifactRelationship.create("position"=>3, "relation_type"=>"parentchild", "sink_id"=>6, "source_id"=>2)
