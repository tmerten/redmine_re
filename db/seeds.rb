...
Role.create("assignable"=>true, "issues_visibility"=>"default", "name"=>"Anonymous", "permissions"=>[:view_issues, :view_gantt, :view_calendar, :view_time_entries, :view_documents, :view_wiki_pages, :view_wiki_edits, :view_files, :browse_repository, :view_changesets], "position"=>2)
