...
Here you can find an online demo of <Redmine RE>(http://redmine-re.korem.de:8080)
* User: re-admin
* Password: redmine-re

== Installation

Here you can find information about <how to install the Redmine RE>(http://redmine-re.korem.de/projects/redmine-re/wiki/Installing_Redmine_RE)
