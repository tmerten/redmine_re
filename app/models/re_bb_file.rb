class ReBbFile < ReBuildingBlock
  unloadable
  
 
  @@data_form_partial_strategy = 're_building_block/re_bb_file/data_form'
  @@multiple_data_form_partial_strategy = 're_building_block/re_bb_file/multiple_data_form'
